...
<body>
	...
	<div class="container mt-5">
        <br><h4>재고조회 <button class="btn-open-modal_1 btn btn-outline-secondary">재고등록</button></h4>
        ...
        <table id="datatablesSimple" class="table table-striped table-hover">
			...
			<div class="modal_1">
					...
					<!-- 	<div class="input-group mb-3">
						...
						<!-- 수량 추가 -->
						<div class="input-group mb-3">
							<input name="mrStock" type="text" class="form-control" placeholder="수량" aria-describedby="button-addon2">
						</div>
				 ...
				 <div class="modal_2">
				         <div class="modal_body_2">
				         	<form action="/update" method="post">
								<h3>재고 내역 수정</h3>
								<br>	
								원자재 코드는 실제 재고 테이블에 있는 원자재 코드를 입력해야 합니다
								<br><br>
										...
										<!-- 수량 수정 -->
										<div class="input-group mb-3">
											<input name="mrStock" type="text" class="form-control" placeholder="수정할 수량" aria-label="mrStock" aria-describedby="button-addon2">
										</div>
										...
										<button type="button" class="btn-close-modal_2 btn btn-outline-secondary" data-bs-dismiss="modal_2" aria-label="Close">이전</button>
									</form>		
						</div>
					</div>
